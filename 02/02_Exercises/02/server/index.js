...
Special task is in fetchData.js, showData.js and error.html in
order make a testcall to the server. If the server does not run,
then client is redirected to error.html.
*/
